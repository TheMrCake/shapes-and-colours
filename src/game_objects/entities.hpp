...
inline EntityId create_light_ray(EntityManager& em, const sf::Vector2u& windowSize,const sf::Vector2f& dir,float wavelength = 550.f) {
    ...
    shape.shape = std::make_unique<sf::RectangleShape>(sf::Vector2f(windowSize.x, 6.f)); // long beam
